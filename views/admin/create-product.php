  ...
  <body>
    <div class="container">
      <div class="row">
        ...
        <div class="col-12">
            <form class="row" action="<?php echo $parameters['root_url']; ?>products/store" method="post" enctype="multipart/form-data">
              ...
              <div class="col-6 mb-3">
                  ...
                  <input type="text" class="form-control" id="price" name="price" placeholder="قیمت (ریال)">
              </div>
              <div class="col-6 mb-3">
                  <label for="stock" class="form-label">موجودی</label>
                  <input type="number" class="form-control" id="stock" name="stock" placeholder="موجودی">
              </div>
              <div class="col-6 mb-3">
                  <label for="discount_percent" class="form-label">درصد تخفیف</label>
                  <input type="number" class="form-control" id="discount_percent" name="discount_percent" placeholder="درصد تخفیف" min="0" max="100">
              </div>
              <div class="col-6 mb-3">
